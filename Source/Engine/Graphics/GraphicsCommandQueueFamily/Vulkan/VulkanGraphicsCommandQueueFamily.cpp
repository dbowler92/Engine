#include "VulkanGraphicsCommandQueueFamily.h"

using namespace EngineAPI::Graphics::Platform;

void VulkanGraphicsCommandQueueFamily::Shutdown()
{
...
bool VulkanGraphicsCommandQueueFamily::InitVulkanQueueFamily(QueueFamilySupport role,
	...
	VkDeviceQueueCreateInfo* creationStructOut)
{
	...
	commandQueuesArray = GE_NEW GraphicsCommandQueue[queueCount];
...
bool VulkanGraphicsCommandQueueFamily::InitVulkanQueues(VkDevice* logicalDevice)
{
