...
//Base
#include "../Common/CommonGraphicsCommandQueueFamily.h"
...
namespace EngineAPI
{
	namespace Graphics
	{
		namespace Platform
		{
			class VulkanGraphicsCommandQueueFamily : public EngineAPI::Graphics::Interface::CommonGraphicsCommandQueueFamily
			{
			public:
				VulkanGraphicsCommandQueueFamily() {};
				virtual ~VulkanGraphicsCommandQueueFamily() = 0 {};
