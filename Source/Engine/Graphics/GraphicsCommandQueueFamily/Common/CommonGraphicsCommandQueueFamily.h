...
#include "../../GraphicsCommandQueue/GraphicsCommandQueue.h"
...
namespace EngineAPI
{
	namespace Graphics
	{
		namespace Interface
		{
			class CommonGraphicsCommandQueueFamily
			{
			public:
				CommonGraphicsCommandQueueFamily() {};
				virtual ~CommonGraphicsCommandQueueFamily() = 0 {};
			...
			protected:
				...
				GraphicsCommandQueue* commandQueuesArray = nullptr;
